...
public class UserInterface {
	...
	//Constructor
	public UserInterface(ArrayList<Animal> lista) {
		...
		boton1.setBounds(ancho/2-100, 110, 200, 50);
		
		boton2=new JButton("2.Mostrar animales");
		boton2.setBounds(ancho/2-100, 220, 200, 50);
		
		boton3=new JButton("3.Comportamientos");
		boton3.setBounds(ancho/2-100, 330, 200, 50);
